...
export default function AdminPage() {
  ...
  const parsedOperators = (operatorsList || "")
    .split(",")
    .map(o => o.trim())
    .filter(Boolean);
  ...
  const handleManualSubmit = async (e) => {
    ...
    try {
      ...
      const periodStartIso = new Date(`${manualForm.flightDate}T${manualForm.startTime}:00-03:00`).toISOString();
      const periodEndIso = new Date(`${manualForm.flightDate}T${manualForm.endTime}:00-03:00`).toISOString();
      ...
      const payload = {
        ...
        notes: manualForm.opNotes || "Lançamento manual direto pelo administrador."
      };
      ...
      setSuccessMsg("Prorrogação manual registrada com sucesso!");
          ...
          <>
            ...
            <div style={{ display: "flex", gap: "12px", marginBottom: "16px", flexWrap: "wrap", alignItems: "stretch" }}>
              ...
              <button 
                ...
                title="Lançar prorrogação/antecipação diretamente pelo administrador sem envio de e-mails"
              >
                <Plus size={16} />
